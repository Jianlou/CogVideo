...
srun --partition-id share-a \
    ...
    --nodes 1 \
    --priority highest \
    --container-image registry.cn-sh-01.sensecore.cn/devsft-ccr/ubuntu22.04_cuda12.4_cogvx:v2.1.0 \
    --container-mounts 4ba8dc8e-52e5-11ee-82fd-de3a99f44f33:/mnt/afs_1 \
    bash -c "cd \"${HOME_DIR}\"; \
    source /root/miniconda3/bin/activate cogvx_diff; \
    $environs accelerate launch --config_file finetune/accelerate_config_machine_single_8.yaml --multi_gpu \
