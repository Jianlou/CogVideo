...
MODEL_PATH=${2:-models/CogVideoX-5b}
...
srun --partition-id share-a \
    ...
    $environs accelerate launch --config_file finetune/accelerate_config_machine_single_zero3.yaml --multi_gpu\
